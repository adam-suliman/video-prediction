...
\begin{frame}{Ablation: статистический prior}
    ...
    \scriptsize
    \parbox{0.9\textwidth}{
        Показана сводка: качество без prior и лучший tested prior.
        Prior дает большой прирост plain GRU, но почти не улучшает JointGRU,
        где совместимость пары уже моделируется action head.
    }
\end{frame}
...
\begin{frame}{Репозиторий и воспроизводимость}
    \centering
    \vspace{0.25cm}
    \qrcode[height=0.46\textheight]{https://github.com/adam-suliman/video-prediction}

    \vspace{0.5cm}
    \Large
    \href{https://github.com/adam-suliman/video-prediction}{\texttt{github.com/adam-suliman/video-prediction}}
\end{frame}
